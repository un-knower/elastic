...
public class CommoditySerchModel extends BaseSerchModel {
	...
	private List<Long> radioSpecs;//单选spec
	
	private List<Long> checkBoxSpecs;//复选spec
	...
	@ApiModelProperty(value = "单选spec")
	public List<Long> getRadioSpecs() {
		return radioSpecs;
	}
	public void setRadioSpecs(List<Long> radioSpecs) {
		this.radioSpecs = radioSpecs;
	}
	@ApiModelProperty(value = "复选spec")
	public List<Long> getCheckBoxSpecs() {
		return checkBoxSpecs;
	}
	public void setCheckBoxSpecs(List<Long> checkBoxSpecs) {
		this.checkBoxSpecs = checkBoxSpecs;
	}
}
